...
import 'package:kajian_fikih/view/auth/forget_password_screen.dart';
import 'package:kajian_fikih/view/jamaah/dashboard/dashboard_screen.dart';
import 'package:kajian_fikih/view/auth/register_sceen.dart';
        ...
        listener: (BuildContext context, AuthState state) {
          ...
          if (state is LoginSuccessState) {
            if (state.userDetail.role == "ustadz") {
              ...
              preferencesUtils.savePreferencesString("role", "ustadz");
              AnimatedSnackBar.material(
              ...
              preferencesUtils.savePreferencesBool("googleLogin", false);
              preferencesUtils.savePreferencesString("role", "jamaah");
              AnimatedSnackBar.material(
